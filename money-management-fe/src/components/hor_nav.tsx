...
export const HNav = () => {
    ...
    return (
        <div className="w-full h-fit bg-white divide-y divide-gray-300">
            <div className="py-[10px] px-[20px] flex justify-between items-center">
                <div className="flex justify-start items-center p-[8px]">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" id="menu-btn" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-6">
